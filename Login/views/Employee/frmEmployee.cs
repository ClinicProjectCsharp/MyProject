...
namespace ProjectCsharp.Login.views.Employee
{
    public partial class frmEmployee : Form
    {
        ...
        private void TableFormatting()
        {
            ...
            /*  dataGridView1.Columns["EmployeeName"].Width = 150;*/ // عرض أكبر (يمكنك تعديل الرقم حسب الحاجة)

            // تصغير عرض عمود "رقم"
            /*  dataGridView1.Columns["DepartmentID"].Width = 40;*/ // عرض أصغر (يمكنك تعديل الرقم حسب الحاجة)
        ...
        {// مسح الصنديق الذي تحت يم بعد اي عمليه عملتوه
            ...
            rdoMale.Enabled = false; // مثال على إعادة تعيين أزرار الراديو
            Checked.Checked = false;
        }
        ...
        private void btnClearFromDB_Click_1(object sender, EventArgs e)
        {
            btnClearFromDBs();
            ClearFields();
        }
